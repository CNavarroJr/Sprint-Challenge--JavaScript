...
const contactInfo = ['Cynde ctorry0@macromedia.com', 'Saundra swhal1@state.gov', 'Lambert lparham2@techcrunch.com', 'Modestne mdolder3@symantec.com', 'Chick camorts4@google.com.au', 'Jakob jharken5@spiegel.de', 'Robbi rbrister6@redcross.org', 'Colline cbrosh7@alibaba.com', 'Michail mrome8@shinystat.com', 'Hube hlethbrig9@foxnews.com'];
...
const lowCaseAnimalNames = ['Jackal, asiatic', 'Screamer, southern', 'White spoonbill', 'White-cheeked pintail', 'Black-backed jackal', 'Brolga crane', 'Common melba finch', 'Pampa gray fox', 'Hawk-eagle, crowned', 'Australian pelican'].map(lowCase => lowCase.toLowerCase());
...
*/
const populationTotal = zooAnimals.reduce((sum, curr_val) => {
  return sum + curr_val.population;
}, 0);
